...
const resume = [
  ...
  },
  {
    ...
    company: "Texada",
    bullets: [
      "Managed and mentored a multi-product design team, ensuring consistent UX through scalable patterns and a shared design system.",
      "Developed and implemented a cross-product design system across multiple tech stacks and frameworks.",
      "Led the UX vision for a significant product redesign, integrating stakeholder feedback and legacy system constraints into a modern, intuitive interface.",
      "Helped innovate, research, and introduce AI features into core user workflows, significantly increasing productivity in everyday tasks.",
