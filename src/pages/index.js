...
import resume from "./AnnaKlibanovResume.pdf"
    ...
    <Layout pageTitle="home">
      ...
      <section className="py-5 contact">
        <div className="container mx-auto pt-4 pb-12 text-xl">
            ...
            <a href={resume} className="block w-fit bg-pink-600 hover:bg-blue-700 text-white text-sm mt-10 py-2 px-4 rounded-full">Download Resume</a>
        </div>
      </section>
    </Layout>
